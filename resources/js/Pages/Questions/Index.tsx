...
export default function Index({ questions, subjects, filters }: Props) {
    ...
    useEffect(() => {
        router.get(
            ...
            { search: debouncedSearch, subject_id: subjectId },
        ...
        >
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex flex-1 gap-4">
                    ...
                    <select
                        className="rounded-lg border border-gray-300 bg-white p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500"
                        value={subjectId}
                ...
                <div className="flex gap-2">
                    <button
                        ...
                        className="flex items-center justify-center gap-2 rounded-lg bg-green-600 px-4 py-2 text-sm font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-4 focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
                    >
                        <Upload className="h-4 w-4" />
                        Import
                    </button>
                    <a
                        href={route('questions.export')}
                        className="flex items-center justify-center gap-2 rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    >
                        ...
                        <tbody>
                            {questions.data.length > 0 ? (
                                questions.data.map((question, index) => (
                                    <tr key={question.id} className="border-b bg-white hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-600">
                                        ...
                                        <td className="px-6 py-4 font-medium text-gray-900 dark:text-white line-clamp-2">
                                            {question.content}
                                        </td>
            ...
            <Modal show={showImportModal} onClose={() => setShowImportModal(false)}>
                <form onSubmit={handleImport} className="p-6">
                    ...
                    <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                        Upload an Excel file (.xlsx, .xls) to import questions.
                    </p>
                    <div className="mt-6">
